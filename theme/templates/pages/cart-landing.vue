...
"props": [
    ...
    {
      "type": "checkbox",
      "id": "is_commentmandatory",
      "label": "Enable Comment Mandatory",
      "default": false,
      "info": "Mark comment field as mandatory on cart"
    },
    {
      "type": "text",
      "id": "customize_comment",
      "label": "Comment Title",
      "default": "Comment",
      "info": "Customize Comment title on Cart"
    },
    {
      "type": "text",
      "id": "customize_comment_errortext",
