<template>
  <div
    ...
    :style="
      `--header_nav_hover_color:${global_config.props.header_nav_hover_color};--header_icon_color:${global_config.props.header_icon_color};`
    "
  >
    <div
      class="header"
      :style="
        `background-color: ${global_config.props.header_bg_color};color: ${global_config.props.header_text_color}`
      "
    >
      <div
        class="desktop desktop-nav"
        :style="
          `border-bottom: 1px solid ${global_config.props.header_border_color};background-color: ${global_config.props.header_bg_color};`
        "
      >
              ...
              /> -->
                ...
                >
                  ...
                  <p
                    ...
                    :style="
                      `background-color: ${global_config.props.header_cart_notification_bg_color};color: ${global_config.props.header_cart_notification_text_color};`
                    "
                  >
                  ...
                  >
                    ...
                    /> -->
                        <svg
                          ...
                          viewBox="0 0 512 512"
                          :style="
                            `fill:${global_config.props.header_icon_color}`
                          "
                          xml:space="preserve"
                        >
                          <path
