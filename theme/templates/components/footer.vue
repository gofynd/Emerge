  ...
  >
    <div class="main-footer__bottom" :style="getArtwork">
      ...
      <div class="social-link-block">
        ...
        <div class="flat">
          <ul class="list" v-if="isContactEmail">
            <li>Email: {{ context.support.contact.email.email[0].value }}</li>
          </ul>
          <ul class="list" v-if="isContactNo">
    ...
    <div
      class="sub-footer_bottom"
      v-if="context && context.app_info && context.app_info.copyright_text"
    >
