            ...
            <div class="price-cntr">
              <span class="effective-price strong bold-xxs">
                <template v-if="item.is_set">
                  {{ item.price_per_unit.converted.selling | currencyformat }}
                  /Pcs
                </template>
                <template v-else>
                  {{ item.price.converted.selling | currencyformat }}
                </template>
              </span>
              <span
                class="marked-price"
                v-if="
                  item.price.converted.selling !== item.price.converted.marked
                "
              >
                <template v-if="item.is_set">
